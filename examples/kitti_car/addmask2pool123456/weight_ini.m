...
caffe.reset_all();
%caffe.set_mode_cpu();
model1='../mscnn_ori/mscnn_deploy.prototxt';
model2='trainval_2nd.prototxt';

weight1='../mscnn_ori/mscnn_ori.caffemodel';
...
convk_1_1=net1.layers(['LFCN_4_5x5']).params(1).get_data();
convk_1_2=net1.layers(['LFCN_4_5x5']).params(2).get_data();
convk_1_new1=net2.layers(['LFCN_4_5x5_new']).params(1).get_data();
convk_1_new2=net2.layers(['LFCN_4_5x5_new']).params(2).get_data();
[w h chin chout]=size(convk_1_1);
convk_1_new1(:,:,1:chin,:)=convk_1_1;
net2.layers(['LFCN_4_5x5_new']).params(1).set_data(convk_1_new1);
net2.layers(['LFCN_4_5x5_new']).params(2).set_data(convk_1_2);
