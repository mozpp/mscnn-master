...
proj_list={'addmask2pool12345'};%'addmask2pool1' 'addmask2pool2' 'addmask2pool3'
nFold=length(proj_list);
for k0=1:nFold
...
image_dir = ['/media/b3-542/LIBRARY/moz/result/concat/addfpfn/area_bias3/blob_jan30_xgt_val_ab3/'];
%image_dir = ['/media/b3-542/LIBRARY/moz/dataset/concat_mscnnThre_val/'];
