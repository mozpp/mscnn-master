...
proj_list={'addmask2pool1' 'addmask2pool2' 'addmask2pool3' 'mscnn_stage2_oriAnchor'};
%proj_list={'addmask2pool4','addmask2pool5','addmask2pool12345'};
root_dir='/media/b3-542/LIBRARY/moz/result/concat/addfpfn/area_bias3/';
img_root_list = {'add_fn_new0.2_ab3Val' 'add_fn_new0.3_ab3Val' 'add_fn_new0.4_ab3Val' 'add_fn_new0.5_ab3Val'...
    'add_fp_new0.2_ab3Val' 'add_fp_new0.3_ab3Val' 'add_fp_new0.4_ab3Val' 'add_fp_new0.5_ab3Val'...
    'blob_jan30_xgt_val_ab3'};
nProj=length(proj_list);
nVal=length(img_root_list);
for k0=1:nProj
for k1=1:nVal
model_root_dir=proj_list{1,k0};
img_dir1=img_root_list{1,k1};
binary_file = [model_root_dir '/' 'xgt.caffemodel'];
...
%image_dir = [root_dir 'concat_xgt1/val/'];
%image_dir = [root_dir 'concat_blob_stats/val/'];
...
comp_id = [model_root_dir '_xgt_' img_dir1];
