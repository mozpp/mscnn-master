...
addpath('../../utils/');
caffe.reset_all();
root_dir = 'mobile1_stage2_2/';%  add2pool123_stage2
...
%root_dir = '/media/b3-542/LIBRARY/moz/dataset/';
%image_dir = ['/media/b3-542/LIBRARY/moz/result/concat/blob_jan30_xgt_val/'];
%image_dir = ['/media/b3-542/LIBRARY/moz/result/concat/blob_stats_jan30_val/'];
%image_dir='/media/b3-542/LIBRARY/moz/result/concat/temp/';
image_dir='/media/b3-542/library2/moz/night_det/result/HK_dataset/concat/blob_stats_val/';
%image_dir = '/media/b3-542/LIBRARY/moz/dataset/HK_dataset/concat/blob_x_gt_val/';
%image_dir='/home/b3-542/Documents/moz/dataset/concat/subcls_blob_val/';
%image_dir='/media/b3-542/LIBRARY/moz/result/concat/SubBlobTo1Ch_val/';
%image_dir='/media/b3-542/LIBRARY/moz/result/concat/blob_stats_jan30_val/';
%image_dir='/media/b3-542/library2/moz/night_det/result/HK_dataset/concat/blob_clsf_2Ch_val/';
...
%       %saveas(handle,['results/'  image_list{k,1} '.jpg']);
  ...
  if (mod(k,50)==0), fprintf('idx %i/%i, avgtime=%.4fs\n',k,nImg,avgtime); end
end
