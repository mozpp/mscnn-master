...
class ImageGtDataParameter;
class SPPParameter;
class ROIPoolingParameter;
class SmoothL1LossParameter;
class DetectionLossParameter;
class DetectionAccuracyParameter;
class BoxOutputParameter;
class ProposalTargetParameter;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.DetectionLossParameter detection_loss_param = 149;
  inline bool has_detection_loss_param() const;
  inline void clear_detection_loss_param();
  static const int kDetectionLossParamFieldNumber = 149;
  ...
  // optional .caffe.DetectionAccuracyParameter detection_accuracy_param = 150;
  inline bool has_detection_accuracy_param() const;
  inline void clear_detection_accuracy_param();
  static const int kDetectionAccuracyParamFieldNumber = 150;
  inline const ::caffe::DetectionAccuracyParameter& detection_accuracy_param() const;
  inline ::caffe::DetectionAccuracyParameter* mutable_detection_accuracy_param();
  inline ::caffe::DetectionAccuracyParameter* release_detection_accuracy_param();
  inline void set_allocated_detection_accuracy_param(::caffe::DetectionAccuracyParameter* detection_accuracy_param);

  // optional .caffe.BoxOutputParameter box_output_param = 151;
  inline bool has_box_output_param() const;
  inline void clear_box_output_param();
  static const int kBoxOutputParamFieldNumber = 151;
  inline const ::caffe::BoxOutputParameter& box_output_param() const;
  inline ::caffe::BoxOutputParameter* mutable_box_output_param();
  inline ::caffe::BoxOutputParameter* release_box_output_param();
  inline void set_allocated_box_output_param(::caffe::BoxOutputParameter* box_output_param);

  // optional .caffe.ProposalTargetParameter proposal_target_param = 152;
  inline bool has_proposal_target_param() const;
  inline void clear_proposal_target_param();
  static const int kProposalTargetParamFieldNumber = 152;
  inline const ::caffe::ProposalTargetParameter& proposal_target_param() const;
  inline ::caffe::ProposalTargetParameter* mutable_proposal_target_param();
  inline ::caffe::ProposalTargetParameter* release_proposal_target_param();
  inline void set_allocated_proposal_target_param(::caffe::ProposalTargetParameter* proposal_target_param);

  // optional .caffe.ImageGtDataParameter image_gt_data_param = 153;
  inline bool has_image_gt_data_param() const;
  inline void clear_image_gt_data_param();
  static const int kImageGtDataParamFieldNumber = 153;
  inline const ::caffe::ImageGtDataParameter& image_gt_data_param() const;
  inline ::caffe::ImageGtDataParameter* mutable_image_gt_data_param();
  inline ::caffe::ImageGtDataParameter* release_image_gt_data_param();
  inline void set_allocated_image_gt_data_param(::caffe::ImageGtDataParameter* image_gt_data_param);

  // optional .caffe.BBoxRegParameter bbox_reg_param = 154;
  inline bool has_bbox_reg_param() const;
  inline void clear_bbox_reg_param();
  static const int kBboxRegParamFieldNumber = 154;
  inline const ::caffe::BBoxRegParameter& bbox_reg_param() const;
  inline ::caffe::BBoxRegParameter* mutable_bbox_reg_param();
  inline ::caffe::BBoxRegParameter* release_bbox_reg_param();
  inline void set_allocated_bbox_reg_param(::caffe::BBoxRegParameter* bbox_reg_param);

  // optional .caffe.MatMulParameter matmul_param = 155;
  inline bool has_matmul_param() const;
  inline void clear_matmul_param();
  static const int kMatmulParamFieldNumber = 155;
  inline const ::caffe::MatMulParameter& matmul_param() const;
  inline ::caffe::MatMulParameter* mutable_matmul_param();
  inline ::caffe::MatMulParameter* release_matmul_param();
  inline void set_allocated_matmul_param(::caffe::MatMulParameter* matmul_param);
 ...
 private:
  ...
  inline void set_has_detection_accuracy_param();
  inline void clear_has_detection_accuracy_param();
  inline void set_has_box_output_param();
  inline void clear_has_box_output_param();
  inline void set_has_proposal_target_param();
  inline void clear_has_proposal_target_param();
  inline void set_has_image_gt_data_param();
  inline void clear_has_image_gt_data_param();
  inline void set_has_bbox_reg_param();
  inline void clear_has_bbox_reg_param();
  inline void set_has_matmul_param();
  inline void clear_has_matmul_param();
  ...
  ::caffe::DetectionAccuracyParameter* detection_accuracy_param_;
  ::caffe::BoxOutputParameter* box_output_param_;
  ::caffe::ProposalTargetParameter* proposal_target_param_;
  ::caffe::ImageGtDataParameter* image_gt_data_param_;
  ::caffe::BBoxRegParameter* bbox_reg_param_;
  ::caffe::MatMulParameter* matmul_param_;
  int phase_;
...
class MatMulParameter : public ::google::protobuf::Message {
 public:
  MatMulParameter();
  virtual ~MatMulParameter();

  MatMulParameter(const MatMulParameter& from);

  inline MatMulParameter& operator=(const MatMulParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const MatMulParameter& default_instance();

  void Swap(MatMulParameter* other);

  // implements Message ----------------------------------------------

  MatMulParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const MatMulParameter& from);
  void MergeFrom(const MatMulParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline bool has_transpose_a() const;
  inline void clear_transpose_a();
  static const int kTransposeAFieldNumber = 1;
  inline bool transpose_a() const;
  inline void set_transpose_a(bool value);

  // optional bool transpose_b = 2 [default = true];
  inline bool has_transpose_b() const;
  inline void clear_transpose_b();
  static const int kTransposeBFieldNumber = 2;
  inline bool transpose_b() const;
  inline void set_transpose_b(bool value);

  // @@protoc_insertion_point(class_scope:caffe.MatMulParameter)
 private:
  inline void set_has_transpose_a();
  inline void clear_has_transpose_a();
  inline void set_has_transpose_b();
  inline void clear_has_transpose_b();
  ...
  void InitAsDefaultInstance();
  static MatMulParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class ImageGtDataParameter : public ::google::protobuf::Message {
 public:
  ImageGtDataParameter();
  virtual ~ImageGtDataParameter();

  ImageGtDataParameter(const ImageGtDataParameter& from);

  inline ImageGtDataParameter& operator=(const ImageGtDataParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const ImageGtDataParameter& default_instance();

  void Swap(ImageGtDataParameter* other);

  // implements Message ----------------------------------------------

  ImageGtDataParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const ImageGtDataParameter& from);
  void MergeFrom(const ImageGtDataParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline int downsample_rate_size() const;
  inline void clear_downsample_rate();
  static const int kDownsampleRateFieldNumber = 6;
  inline ::google::protobuf::uint32 downsample_rate(int index) const;
  inline void set_downsample_rate(int index, ::google::protobuf::uint32 value);
  inline void add_downsample_rate(::google::protobuf::uint32 value);
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
      downsample_rate() const;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
      mutable_downsample_rate();

  // optional uint32 coord_num = 7 [default = 4];
  inline bool has_coord_num() const;
  inline void clear_coord_num();
  static const int kCoordNumFieldNumber = 7;
  inline ::google::protobuf::uint32 coord_num() const;
  inline void set_coord_num(::google::protobuf::uint32 value);

  // repeated uint32 field_h = 8;
  inline int field_h_size() const;
  inline void clear_field_h();
  static const int kFieldHFieldNumber = 8;
  inline ::google::protobuf::uint32 field_h(int index) const;
  inline void set_field_h(int index, ::google::protobuf::uint32 value);
  inline void add_field_h(::google::protobuf::uint32 value);
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
      field_h() const;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
      mutable_field_h();

  // repeated uint32 field_w = 9;
  inline int field_w_size() const;
  inline void clear_field_w();
  static const int kFieldWFieldNumber = 9;
  inline ::google::protobuf::uint32 field_w(int index) const;
  inline void set_field_w(int index, ::google::protobuf::uint32 value);
  inline void add_field_w(::google::protobuf::uint32 value);
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
      field_w() const;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
      mutable_field_w();

  // optional float fg_threshold = 10 [default = 0.5];
  inline bool has_fg_threshold() const;
  inline void clear_fg_threshold();
  static const int kFgThresholdFieldNumber = 10;
  inline float fg_threshold() const;
  inline void set_fg_threshold(float value);

  // optional uint32 resize_width = 11;
  inline bool has_resize_width() const;
  inline void clear_resize_width();
  static const int kResizeWidthFieldNumber = 11;
  inline ::google::protobuf::uint32 resize_width() const;
  inline void set_resize_width(::google::protobuf::uint32 value);

  // optional uint32 resize_height = 12;
  inline bool has_resize_height() const;
  inline void clear_resize_height();
  static const int kResizeHeightFieldNumber = 12;
  inline ::google::protobuf::uint32 resize_height() const;
  inline void set_resize_height(::google::protobuf::uint32 value);

  // optional uint32 crop_width = 13 [default = 0];
  inline bool has_crop_width() const;
  inline void clear_crop_width();
  static const int kCropWidthFieldNumber = 13;
  inline ::google::protobuf::uint32 crop_width() const;
  inline void set_crop_width(::google::protobuf::uint32 value);

  // optional uint32 crop_height = 14 [default = 0];
  inline bool has_crop_height() const;
  inline void clear_crop_height();
  static const int kCropHeightFieldNumber = 14;
  inline ::google::protobuf::uint32 crop_height() const;
  inline void set_crop_height(::google::protobuf::uint32 value);

  // optional bool do_multiple_scale = 15 [default = false];
  inline bool has_do_multiple_scale() const;
  inline void clear_do_multiple_scale();
  static const int kDoMultipleScaleFieldNumber = 15;
  inline bool do_multiple_scale() const;
  inline void set_do_multiple_scale(bool value);

  // optional uint32 min_scale = 16;
  inline bool has_min_scale() const;
  inline void clear_min_scale();
  static const int kMinScaleFieldNumber = 16;
  inline ::google::protobuf::uint32 min_scale() const;
  inline void set_min_scale(::google::protobuf::uint32 value);

  // optional uint32 max_scale = 17;
  inline bool has_max_scale() const;
  inline void clear_max_scale();
  static const int kMaxScaleFieldNumber = 17;
  inline ::google::protobuf::uint32 max_scale() const;
  inline void set_max_scale(::google::protobuf::uint32 value);

  // optional float min_whaspect = 18;
  inline bool has_min_whaspect() const;
  inline void clear_min_whaspect();
  static const int kMinWhaspectFieldNumber = 18;
  inline float min_whaspect() const;
  inline void set_min_whaspect(float value);

  // optional float max_whaspect = 19;
  inline bool has_max_whaspect() const;
  inline void clear_max_whaspect();
  static const int kMaxWhaspectFieldNumber = 19;
  inline float max_whaspect() const;
  inline void set_max_whaspect(float value);

  // optional float min_gt_width = 20 [default = 0];
  inline bool has_min_gt_width() const;
  inline void clear_min_gt_width();
  static const int kMinGtWidthFieldNumber = 20;
  inline float min_gt_width() const;
  inline void set_min_gt_width(float value);

  // optional float min_gt_height = 21 [default = 0];
  inline bool has_min_gt_height() const;
  inline void clear_min_gt_height();
  static const int kMinGtHeightFieldNumber = 21;
  inline float min_gt_height() const;
  inline void set_min_gt_height(float value);

  // optional bool shuffle = 22 [default = false];
  inline bool has_shuffle() const;
  inline void clear_shuffle();
  static const int kShuffleFieldNumber = 22;
  inline bool shuffle() const;
  inline void set_shuffle(bool value);

  // optional bool output_gt_boxes = 23 [default = false];
  inline bool has_output_gt_boxes() const;
  inline void clear_output_gt_boxes();
  static const int kOutputGtBoxesFieldNumber = 23;
  inline bool output_gt_boxes() const;
  inline void set_output_gt_boxes(bool value);

  // optional uint32 fg_img_multiple = 24 [default = 1];
  inline bool has_fg_img_multiple() const;
  inline void clear_fg_img_multiple();
  static const int kFgImgMultipleFieldNumber = 24;
  inline ::google::protobuf::uint32 fg_img_multiple() const;
  inline void set_fg_img_multiple(::google::protobuf::uint32 value);

  // optional bool cache_images = 25 [default = false];
  inline bool has_cache_images() const;
  inline void clear_cache_images();
  static const int kCacheImagesFieldNumber = 25;
  inline bool cache_images() const;
  inline void set_cache_images(bool value);

  // optional string root_folder = 26 [default = ""];
  inline bool has_root_folder() const;
  inline void clear_root_folder();
  static const int kRootFolderFieldNumber = 26;
  inline const ::std::string& root_folder() const;
  inline void set_root_folder(const ::std::string& value);
  inline void set_root_folder(const char* value);
  inline void set_root_folder(const char* value, size_t size);
 ...
 private:
  ...
  inline void set_has_mirror();
  inline void clear_has_mirror();
  inline void set_has_coord_num();
  inline void clear_has_coord_num();
  inline void set_has_fg_threshold();
  inline void clear_has_fg_threshold();
  ...
  inline void set_has_do_multiple_scale();
  inline void clear_has_do_multiple_scale();
  inline void set_has_min_scale();
  inline void clear_has_min_scale();
  inline void set_has_max_scale();
  inline void clear_has_max_scale();
  inline void set_has_min_whaspect();
  inline void clear_has_min_whaspect();
  inline void set_has_max_whaspect();
  inline void clear_has_max_whaspect();
  inline void set_has_min_gt_width();
  inline void clear_has_min_gt_width();
  inline void set_has_min_gt_height();
  inline void clear_has_min_gt_height();
  inline void set_has_shuffle();
  inline void clear_has_shuffle();
  inline void set_has_output_gt_boxes();
  inline void clear_has_output_gt_boxes();
  inline void set_has_fg_img_multiple();
  inline void clear_has_fg_img_multiple();
  inline void set_has_cache_images();
  inline void clear_has_cache_images();
  inline void set_has_root_folder();
  inline void clear_has_root_folder();
  ...
  float scale_;
  ::google::protobuf::uint32 batch_size_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > downsample_rate_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > field_h_;
  ::google::protobuf::uint32 coord_num_;
  float fg_threshold_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > field_w_;
  ...
  ::google::protobuf::uint32 min_scale_;
  bool mirror_;
  bool do_multiple_scale_;
  bool shuffle_;
  bool output_gt_boxes_;
  ::google::protobuf::uint32 max_scale_;
  float min_whaspect_;
  float max_whaspect_;
  float min_gt_width_;
  float min_gt_height_;
  ::google::protobuf::uint32 fg_img_multiple_;
  ::std::string* root_folder_;
  bool cache_images_;
  ...
  void InitAsDefaultInstance();
  static ImageGtDataParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class ROIPoolingParameter : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_pad_ratio() const;
  inline void clear_pad_ratio();
  static const int kPadRatioFieldNumber = 4;
  inline float pad_ratio() const;
  inline void set_pad_ratio(float value);
 ...
 private:
  ...
  inline void set_has_pad_ratio();
  inline void clear_has_pad_ratio();
...
class DetectionLossParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional uint32 cls_num = 1;
  inline bool has_cls_num() const;
  inline void clear_cls_num();
  static const int kClsNumFieldNumber = 1;
  inline ::google::protobuf::uint32 cls_num() const;
  inline void set_cls_num(::google::protobuf::uint32 value);

  // optional uint32 coord_num = 2 [default = 4];
  inline bool has_coord_num() const;
  inline void clear_coord_num();
  static const int kCoordNumFieldNumber = 2;
  inline ::google::protobuf::uint32 coord_num() const;
  inline void set_coord_num(::google::protobuf::uint32 value);

  // optional float lambda = 3 [default = 1];
  ...
  // optional uint32 field_h = 4;
  inline bool has_field_h() const;
  inline void clear_field_h();
  static const int kFieldHFieldNumber = 4;
  inline ::google::protobuf::uint32 field_h() const;
  inline void set_field_h(::google::protobuf::uint32 value);

  // optional uint32 field_w = 5;
  inline bool has_field_w() const;
  inline void clear_field_w();
  static const int kFieldWFieldNumber = 5;
  inline ::google::protobuf::uint32 field_w() const;
  inline void set_field_w(::google::protobuf::uint32 value);

  // optional uint32 downsample_rate = 6;
  inline bool has_downsample_rate() const;
  inline void clear_downsample_rate();
  static const int kDownsampleRateFieldNumber = 6;
  inline ::google::protobuf::uint32 downsample_rate() const;
  inline void set_downsample_rate(::google::protobuf::uint32 value);

  // optional bool bb_smooth = 7 [default = true];
  inline bool has_bb_smooth() const;
  inline void clear_bb_smooth();
  static const int kBbSmoothFieldNumber = 7;
  inline bool bb_smooth() const;
  inline void set_bb_smooth(bool value);

  // optional float field_whr = 8 [default = 2];
  inline bool has_field_whr() const;
  inline void clear_field_whr();
  static const int kFieldWhrFieldNumber = 8;
  inline float field_whr() const;
  inline void set_field_whr(float value);

  // optional float field_xyr = 9 [default = 2];
  inline bool has_field_xyr() const;
  inline void clear_field_xyr();
  static const int kFieldXyrFieldNumber = 9;
  inline float field_xyr() const;
  inline void set_field_xyr(float value);

  // optional float bg_threshold = 10 [default = 0.5];
  inline bool has_bg_threshold() const;
  inline void clear_bg_threshold();
  static const int kBgThresholdFieldNumber = 10;
  inline float bg_threshold() const;
  inline void set_bg_threshold(float value);

  // optional uint32 bg_multiple = 11 [default = 4];
  inline bool has_bg_multiple() const;
  inline void clear_bg_multiple();
  static const int kBgMultipleFieldNumber = 11;
  inline ::google::protobuf::uint32 bg_multiple() const;
  inline void set_bg_multiple(::google::protobuf::uint32 value);

  // optional string sample_mode = 12 [default = "random"];
  inline bool has_sample_mode() const;
  inline void clear_sample_mode();
  static const int kSampleModeFieldNumber = 12;
  inline const ::std::string& sample_mode() const;
  inline void set_sample_mode(const ::std::string& value);
  inline void set_sample_mode(const char* value);
  inline void set_sample_mode(const char* value, size_t size);
  inline ::std::string* mutable_sample_mode();
  inline ::std::string* release_sample_mode();
  inline void set_allocated_sample_mode(::std::string* sample_mode);

  // optional bool objectness = 13 [default = false];
  inline bool has_objectness() const;
  inline void clear_objectness();
  static const int kObjectnessFieldNumber = 13;
  inline bool objectness() const;
  inline void set_objectness(bool value);

  // optional bool iou_weighted = 14 [default = false];
  inline bool has_iou_weighted() const;
  inline void clear_iou_weighted();
  static const int kIouWeightedFieldNumber = 14;
  inline bool iou_weighted() const;
  inline void set_iou_weighted(bool value);

  // optional bool pos_neg_weighted = 15 [default = false];
  inline bool has_pos_neg_weighted() const;
  inline void clear_pos_neg_weighted();
  static const int kPosNegWeightedFieldNumber = 15;
  inline bool pos_neg_weighted() const;
  inline void set_pos_neg_weighted(bool value);

  // @@protoc_insertion_point(class_scope:caffe.DetectionLossParameter)
 private:
  inline void set_has_cls_num();
  inline void clear_has_cls_num();
  inline void set_has_coord_num();
  inline void clear_has_coord_num();
  inline void set_has_lambda();
  inline void clear_has_lambda();
  inline void set_has_field_h();
  inline void clear_has_field_h();
  inline void set_has_field_w();
  inline void clear_has_field_w();
  inline void set_has_downsample_rate();
  inline void clear_has_downsample_rate();
  inline void set_has_bb_smooth();
  inline void clear_has_bb_smooth();
  inline void set_has_field_whr();
  inline void clear_has_field_whr();
  inline void set_has_field_xyr();
  inline void clear_has_field_xyr();
  inline void set_has_bg_threshold();
  inline void clear_has_bg_threshold();
  inline void set_has_bg_multiple();
  inline void clear_has_bg_multiple();
  inline void set_has_sample_mode();
  inline void clear_has_sample_mode();
  inline void set_has_objectness();
  inline void clear_has_objectness();
  inline void set_has_iou_weighted();
  inline void clear_has_iou_weighted();
  inline void set_has_pos_neg_weighted();
  inline void clear_has_pos_neg_weighted();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::uint32 cls_num_;
  ::google::protobuf::uint32 coord_num_;
  float lambda_;
  ::google::protobuf::uint32 field_h_;
  ::google::protobuf::uint32 field_w_;
  ::google::protobuf::uint32 downsample_rate_;
  float field_whr_;
  float field_xyr_;
  float bg_threshold_;
  ::google::protobuf::uint32 bg_multiple_;
  ::std::string* sample_mode_;
  static ::std::string* _default_sample_mode_;
  bool bb_smooth_;
  bool objectness_;
  bool iou_weighted_;
...
class DetectionAccuracyParameter : public ::google::protobuf::Message {
 public:
  DetectionAccuracyParameter();
  virtual ~DetectionAccuracyParameter();

  DetectionAccuracyParameter(const DetectionAccuracyParameter& from);

  inline DetectionAccuracyParameter& operator=(const DetectionAccuracyParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const DetectionAccuracyParameter& default_instance();

  void Swap(DetectionAccuracyParameter* other);

  // implements Message ----------------------------------------------

  DetectionAccuracyParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const DetectionAccuracyParameter& from);
  void MergeFrom(const DetectionAccuracyParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional uint32 field_h = 3;
  inline bool has_field_h() const;
  inline void clear_field_h();
  static const int kFieldHFieldNumber = 3;
  inline ::google::protobuf::uint32 field_h() const;
  inline void set_field_h(::google::protobuf::uint32 value);

  // optional uint32 field_w = 4;
  inline bool has_field_w() const;
  inline void clear_field_w();
  static const int kFieldWFieldNumber = 4;
  inline ::google::protobuf::uint32 field_w() const;
  inline void set_field_w(::google::protobuf::uint32 value);

  // optional uint32 downsample_rate = 5;
  inline bool has_downsample_rate() const;
  inline void clear_downsample_rate();
  static const int kDownsampleRateFieldNumber = 5;
  inline ::google::protobuf::uint32 downsample_rate() const;
  inline void set_downsample_rate(::google::protobuf::uint32 value);

  // optional uint32 top_k = 6 [default = 1];
  inline bool has_top_k() const;
  inline void clear_top_k();
  ...
  inline bool has_field_whr() const;
  inline void clear_field_whr();
  static const int kFieldWhrFieldNumber = 7;
  inline float field_whr() const;
  inline void set_field_whr(float value);

  // optional float field_xyr = 8 [default = 4];
  inline bool has_field_xyr() const;
  inline void clear_field_xyr();
  static const int kFieldXyrFieldNumber = 8;
  inline float field_xyr() const;
  inline void set_field_xyr(float value);

  // optional float bg_threshold = 9 [default = 0.5];
  inline bool has_bg_threshold() const;
  inline void clear_bg_threshold();
  static const int kBgThresholdFieldNumber = 9;
  inline float bg_threshold() const;
  inline void set_bg_threshold(float value);

  // optional bool objectness = 10 [default = false];
  inline bool has_objectness() const;
  inline void clear_objectness();
  static const int kObjectnessFieldNumber = 10;
  inline bool objectness() const;
  inline void set_objectness(bool value);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static DetectionAccuracyParameter* default_instance_;
};
// -------------------------------------------------------------------

class BoxOutputParameter : public ::google::protobuf::Message {
 public:
  BoxOutputParameter();
  virtual ~BoxOutputParameter();

  BoxOutputParameter(const BoxOutputParameter& from);

  inline BoxOutputParameter& operator=(const BoxOutputParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const BoxOutputParameter& default_instance();

  void Swap(BoxOutputParameter* other);

  // implements Message ----------------------------------------------

  BoxOutputParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const BoxOutputParameter& from);
  void MergeFrom(const BoxOutputParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline bool has_fg_thr() const;
  inline void clear_fg_thr();
  static const int kFgThrFieldNumber = 1;
  inline float fg_thr() const;
  inline void set_fg_thr(float value);

  // optional float iou_thr = 2 [default = 0.5];
  inline bool has_iou_thr() const;
  inline void clear_iou_thr();
  static const int kIouThrFieldNumber = 2;
  inline float iou_thr() const;
  inline void set_iou_thr(float value);

  // optional string nms_type = 3 [default = "IOU"];
  inline bool has_nms_type() const;
  inline void clear_nms_type();
  static const int kNmsTypeFieldNumber = 3;
  inline const ::std::string& nms_type() const;
  inline void set_nms_type(const ::std::string& value);
  inline void set_nms_type(const char* value);
  inline void set_nms_type(const char* value, size_t size);
  inline ::std::string* mutable_nms_type();
  inline ::std::string* release_nms_type();
  inline void set_allocated_nms_type(::std::string* nms_type);
  ...
  inline bool has_max_nms_num() const;
  inline void clear_max_nms_num();
  static const int kMaxNmsNumFieldNumber = 9;
  inline ::google::protobuf::uint32 max_nms_num() const;
  inline void set_max_nms_num(::google::protobuf::uint32 value);

  // optional uint32 max_post_nms_num = 10 [default = 0];
  inline bool has_max_post_nms_num() const;
  inline void clear_max_post_nms_num();
  static const int kMaxPostNmsNumFieldNumber = 10;
  inline ::google::protobuf::uint32 max_post_nms_num() const;
  inline void set_max_post_nms_num(::google::protobuf::uint32 value);

  // optional float min_size = 11 [default = 15];
  inline bool has_min_size() const;
  inline void clear_min_size();
  static const int kMinSizeFieldNumber = 11;
 ...
 private:
  inline void set_has_fg_thr();
  inline void clear_has_fg_thr();
  inline void set_has_iou_thr();
  inline void clear_has_iou_thr();
  ...
  inline void set_has_field_xyr();
  inline void clear_has_field_xyr();
  inline void set_has_max_nms_num();
  inline void clear_has_max_nms_num();
  inline void set_has_max_post_nms_num();
  inline void clear_has_max_post_nms_num();
  ...
  float fg_thr_;
  float iou_thr_;
  ::std::string* nms_type_;
  static ::std::string* _default_nms_type_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > field_h_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > field_w_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > downsample_rate_;
  float field_whr_;
  float field_xyr_;
  ::google::protobuf::uint32 max_nms_num_;
  ::google::protobuf::uint32 max_post_nms_num_;
  float min_size_;
  ...
  void InitAsDefaultInstance();
  static BoxOutputParameter* default_instance_;
};
// -------------------------------------------------------------------

class ProposalTargetParameter : public ::google::protobuf::Message {
 public:
  ProposalTargetParameter();
  virtual ~ProposalTargetParameter();

  ProposalTargetParameter(const ProposalTargetParameter& from);

  inline ProposalTargetParameter& operator=(const ProposalTargetParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const ProposalTargetParameter& default_instance();

  void Swap(ProposalTargetParameter* other);

  // implements Message ----------------------------------------------

  ProposalTargetParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const ProposalTargetParameter& from);
  void MergeFrom(const ProposalTargetParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional uint32 batch_size = 2 [default = 128];
  inline bool has_batch_size() const;
  inline void clear_batch_size();
  static const int kBatchSizeFieldNumber = 2;
  inline ::google::protobuf::uint32 batch_size() const;
  ...
  // optional float fg_fraction = 3 [default = 0.25];
  inline bool has_fg_fraction() const;
  inline void clear_fg_fraction();
  static const int kFgFractionFieldNumber = 3;
  inline float fg_fraction() const;
  inline void set_fg_fraction(float value);

  // optional uint32 num_img_per_batch = 4 [default = 4];
  inline bool has_num_img_per_batch() const;
  inline void clear_num_img_per_batch();
  static const int kNumImgPerBatchFieldNumber = 4;
  inline ::google::protobuf::uint32 num_img_per_batch() const;
  inline void set_num_img_per_batch(::google::protobuf::uint32 value);

  // optional float fg_thr = 5 [default = 0.5];
  inline bool has_fg_thr() const;
  inline void clear_fg_thr();
  static const int kFgThrFieldNumber = 5;
  inline float fg_thr() const;
  inline void set_fg_thr(float value);

  // optional float bg_thr_hg = 6 [default = 0.5];
  inline bool has_bg_thr_hg() const;
  inline void clear_bg_thr_hg();
  static const int kBgThrHgFieldNumber = 6;
  inline float bg_thr_hg() const;
  inline void set_bg_thr_hg(float value);

  // optional float bg_thr_lw = 7 [default = 0.1];
  inline bool has_bg_thr_lw() const;
  inline void clear_bg_thr_lw();
  static const int kBgThrLwFieldNumber = 7;
  inline float bg_thr_lw() const;
  inline void set_bg_thr_lw(float value);

  // optional uint32 img_width = 8;
  inline bool has_img_width() const;
  inline void clear_img_width();
  static const int kImgWidthFieldNumber = 8;
  inline ::google::protobuf::uint32 img_width() const;
  inline void set_img_width(::google::protobuf::uint32 value);

  // optional uint32 img_height = 9;
  inline bool has_img_height() const;
  inline void clear_img_height();
  static const int kImgHeightFieldNumber = 9;
  inline ::google::protobuf::uint32 img_height() const;
  inline void set_img_height(::google::protobuf::uint32 value);

  // optional bool iou_weighted = 10 [default = false];
  inline bool has_iou_weighted() const;
  inline void clear_iou_weighted();
  static const int kIouWeightedFieldNumber = 10;
  inline bool iou_weighted() const;
  inline void set_iou_weighted(bool value);
 ...
 private:
  ...
  inline void set_has_fg_fraction();
  inline void clear_has_fg_fraction();
  inline void set_has_num_img_per_batch();
  inline void clear_has_num_img_per_batch();
  inline void set_has_fg_thr();
  inline void clear_has_fg_thr();
  inline void set_has_bg_thr_hg();
  inline void clear_has_bg_thr_hg();
  inline void set_has_bg_thr_lw();
  inline void clear_has_bg_thr_lw();
  ...
  ::google::protobuf::uint32 batch_size_;
  float fg_fraction_;
  ::google::protobuf::uint32 num_img_per_batch_;
  float fg_thr_;
  float bg_thr_hg_;
  float bg_thr_lw_;
  ...
  void InitAsDefaultInstance();
  static ProposalTargetParameter* default_instance_;
};
// -------------------------------------------------------------------

class BBoxRegParameter : public ::google::protobuf::Message {
 public:
  BBoxRegParameter();
  ...
  inline int bbox_mean_size() const;
  inline void clear_bbox_mean();
  static const int kBboxMeanFieldNumber = 1;
  inline float bbox_mean(int index) const;
  inline void set_bbox_mean(int index, float value);
  inline void add_bbox_mean(float value);
  inline const ::google::protobuf::RepeatedField< float >&
      bbox_mean() const;
  inline ::google::protobuf::RepeatedField< float >*
      mutable_bbox_mean();
  ...
  inline int bbox_std_size() const;
  inline void clear_bbox_std();
  static const int kBboxStdFieldNumber = 2;
  inline float bbox_std(int index) const;
  inline void set_bbox_std(int index, float value);
  inline void add_bbox_std(float value);
  inline const ::google::protobuf::RepeatedField< float >&
      bbox_std() const;
  inline ::google::protobuf::RepeatedField< float >*
      mutable_bbox_std();
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static BBoxRegParameter* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .caffe.DetectionAccuracyParameter detection_accuracy_param = 150;
inline bool LayerParameter::has_detection_accuracy_param() const {
  return (_has_bits_[1] & 0x20000000u) != 0;
}
inline void LayerParameter::set_has_detection_accuracy_param() {
  _has_bits_[1] |= 0x20000000u;
}
inline void LayerParameter::clear_has_detection_accuracy_param() {
  _has_bits_[1] &= ~0x20000000u;
}
inline void LayerParameter::clear_detection_accuracy_param() {
  if (detection_accuracy_param_ != NULL) detection_accuracy_param_->::caffe::DetectionAccuracyParameter::Clear();
  clear_has_detection_accuracy_param();
}
inline const ::caffe::DetectionAccuracyParameter& LayerParameter::detection_accuracy_param() const {
  return detection_accuracy_param_ != NULL ? *detection_accuracy_param_ : *default_instance_->detection_accuracy_param_;
}
inline ::caffe::DetectionAccuracyParameter* LayerParameter::mutable_detection_accuracy_param() {
  set_has_detection_accuracy_param();
  if (detection_accuracy_param_ == NULL) detection_accuracy_param_ = new ::caffe::DetectionAccuracyParameter;
  return detection_accuracy_param_;
}
inline ::caffe::DetectionAccuracyParameter* LayerParameter::release_detection_accuracy_param() {
  clear_has_detection_accuracy_param();
  ::caffe::DetectionAccuracyParameter* temp = detection_accuracy_param_;
  detection_accuracy_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_detection_accuracy_param(::caffe::DetectionAccuracyParameter* detection_accuracy_param) {
  delete detection_accuracy_param_;
  detection_accuracy_param_ = detection_accuracy_param;
  if (detection_accuracy_param) {
    set_has_detection_accuracy_param();
  } else {
    clear_has_detection_accuracy_param();
  }
...
// optional .caffe.BoxOutputParameter box_output_param = 151;
inline bool LayerParameter::has_box_output_param() const {
  return (_has_bits_[1] & 0x40000000u) != 0;
}
inline void LayerParameter::set_has_box_output_param() {
  _has_bits_[1] |= 0x40000000u;
}
inline void LayerParameter::clear_has_box_output_param() {
  _has_bits_[1] &= ~0x40000000u;
}
inline void LayerParameter::clear_box_output_param() {
  if (box_output_param_ != NULL) box_output_param_->::caffe::BoxOutputParameter::Clear();
  clear_has_box_output_param();
}
inline const ::caffe::BoxOutputParameter& LayerParameter::box_output_param() const {
  return box_output_param_ != NULL ? *box_output_param_ : *default_instance_->box_output_param_;
}
inline ::caffe::BoxOutputParameter* LayerParameter::mutable_box_output_param() {
  set_has_box_output_param();
  if (box_output_param_ == NULL) box_output_param_ = new ::caffe::BoxOutputParameter;
  return box_output_param_;
}
inline ::caffe::BoxOutputParameter* LayerParameter::release_box_output_param() {
  clear_has_box_output_param();
  ::caffe::BoxOutputParameter* temp = box_output_param_;
  box_output_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_box_output_param(::caffe::BoxOutputParameter* box_output_param) {
  delete box_output_param_;
  box_output_param_ = box_output_param;
  if (box_output_param) {
    set_has_box_output_param();
  } else {
    clear_has_box_output_param();
...
// optional .caffe.ProposalTargetParameter proposal_target_param = 152;
inline bool LayerParameter::has_proposal_target_param() const {
  return (_has_bits_[1] & 0x80000000u) != 0;
}
inline void LayerParameter::set_has_proposal_target_param() {
  _has_bits_[1] |= 0x80000000u;
}
inline void LayerParameter::clear_has_proposal_target_param() {
  _has_bits_[1] &= ~0x80000000u;
}
inline void LayerParameter::clear_proposal_target_param() {
  if (proposal_target_param_ != NULL) proposal_target_param_->::caffe::ProposalTargetParameter::Clear();
  clear_has_proposal_target_param();
}
inline const ::caffe::ProposalTargetParameter& LayerParameter::proposal_target_param() const {
  return proposal_target_param_ != NULL ? *proposal_target_param_ : *default_instance_->proposal_target_param_;
}
inline ::caffe::ProposalTargetParameter* LayerParameter::mutable_proposal_target_param() {
  set_has_proposal_target_param();
  if (proposal_target_param_ == NULL) proposal_target_param_ = new ::caffe::ProposalTargetParameter;
  return proposal_target_param_;
}
inline ::caffe::ProposalTargetParameter* LayerParameter::release_proposal_target_param() {
  clear_has_proposal_target_param();
  ::caffe::ProposalTargetParameter* temp = proposal_target_param_;
  proposal_target_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_proposal_target_param(::caffe::ProposalTargetParameter* proposal_target_param) {
  delete proposal_target_param_;
  proposal_target_param_ = proposal_target_param;
  if (proposal_target_param) {
    set_has_proposal_target_param();
  } else {
    clear_has_proposal_target_param();
  }
...
// optional .caffe.ImageGtDataParameter image_gt_data_param = 153;
inline bool LayerParameter::has_image_gt_data_param() const {
  return (_has_bits_[2] & 0x00000001u) != 0;
}
inline void LayerParameter::set_has_image_gt_data_param() {
  _has_bits_[2] |= 0x00000001u;
}
inline void LayerParameter::clear_has_image_gt_data_param() {
  _has_bits_[2] &= ~0x00000001u;
}
inline void LayerParameter::clear_image_gt_data_param() {
  if (image_gt_data_param_ != NULL) image_gt_data_param_->::caffe::ImageGtDataParameter::Clear();
  clear_has_image_gt_data_param();
}
inline const ::caffe::ImageGtDataParameter& LayerParameter::image_gt_data_param() const {
  return image_gt_data_param_ != NULL ? *image_gt_data_param_ : *default_instance_->image_gt_data_param_;
}
inline ::caffe::ImageGtDataParameter* LayerParameter::mutable_image_gt_data_param() {
  set_has_image_gt_data_param();
  if (image_gt_data_param_ == NULL) image_gt_data_param_ = new ::caffe::ImageGtDataParameter;
  return image_gt_data_param_;
}
inline ::caffe::ImageGtDataParameter* LayerParameter::release_image_gt_data_param() {
  clear_has_image_gt_data_param();
  ::caffe::ImageGtDataParameter* temp = image_gt_data_param_;
  image_gt_data_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_image_gt_data_param(::caffe::ImageGtDataParameter* image_gt_data_param) {
  delete image_gt_data_param_;
  image_gt_data_param_ = image_gt_data_param;
  if (image_gt_data_param) {
    set_has_image_gt_data_param();
  } else {
    clear_has_image_gt_data_param();
  }
...
inline const ::caffe::BBoxRegParameter& LayerParameter::bbox_reg_param() const {
  return bbox_reg_param_ != NULL ? *bbox_reg_param_ : *default_instance_->bbox_reg_param_;
}
inline ::caffe::BBoxRegParameter* LayerParameter::mutable_bbox_reg_param() {
  set_has_bbox_reg_param();
  if (bbox_reg_param_ == NULL) bbox_reg_param_ = new ::caffe::BBoxRegParameter;
...
// optional .caffe.MatMulParameter matmul_param = 155;
inline bool LayerParameter::has_matmul_param() const {
  return (_has_bits_[2] & 0x00000004u) != 0;
}
inline void LayerParameter::set_has_matmul_param() {
  _has_bits_[2] |= 0x00000004u;
}
inline void LayerParameter::clear_has_matmul_param() {
  _has_bits_[2] &= ~0x00000004u;
}
inline void LayerParameter::clear_matmul_param() {
  if (matmul_param_ != NULL) matmul_param_->::caffe::MatMulParameter::Clear();
  clear_has_matmul_param();
}
inline const ::caffe::MatMulParameter& LayerParameter::matmul_param() const {
  return matmul_param_ != NULL ? *matmul_param_ : *default_instance_->matmul_param_;
}
inline ::caffe::MatMulParameter* LayerParameter::mutable_matmul_param() {
  set_has_matmul_param();
  if (matmul_param_ == NULL) matmul_param_ = new ::caffe::MatMulParameter;
  return matmul_param_;
}
inline ::caffe::MatMulParameter* LayerParameter::release_matmul_param() {
  clear_has_matmul_param();
  ::caffe::MatMulParameter* temp = matmul_param_;
  matmul_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_matmul_param(::caffe::MatMulParameter* matmul_param) {
...
// optional bool transpose_a = 1 [default = false];
inline bool MatMulParameter::has_transpose_a() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void MatMulParameter::set_has_transpose_a() {
  _has_bits_[0] |= 0x00000001u;
}
inline void MatMulParameter::clear_has_transpose_a() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void MatMulParameter::clear_transpose_a() {
  transpose_a_ = false;
  clear_has_transpose_a();
}
inline bool MatMulParameter::transpose_a() const {
  return transpose_a_;
}
inline void MatMulParameter::set_transpose_a(bool value) {
  set_has_transpose_a();
  transpose_a_ = value;
}

// optional bool transpose_b = 2 [default = true];
inline bool MatMulParameter::has_transpose_b() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void MatMulParameter::set_has_transpose_b() {
  _has_bits_[0] |= 0x00000002u;
}
inline void MatMulParameter::clear_has_transpose_b() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void MatMulParameter::clear_transpose_b() {
  transpose_b_ = true;
  clear_has_transpose_b();
}
inline bool MatMulParameter::transpose_b() const {
  return transpose_b_;
}
inline void MatMulParameter::set_transpose_b(bool value) {
  set_has_transpose_b();
  transpose_b_ = value;
}
...
// optional string source = 1;
inline bool ImageGtDataParameter::has_source() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void ImageGtDataParameter::set_has_source() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ImageGtDataParameter::clear_has_source() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ImageGtDataParameter::clear_source() {
  if (source_ != &::google::protobuf::internal::kEmptyString) {
    source_->clear();
  }
  clear_has_source();
}
inline const ::std::string& ImageGtDataParameter::source() const {
  return *source_;
}
inline void ImageGtDataParameter::set_source(const ::std::string& value) {
  set_has_source();
  if (source_ == &::google::protobuf::internal::kEmptyString) {
    source_ = new ::std::string;
  }
...
inline void ImageGtDataParameter::set_source(const char* value) {
  set_has_source();
  if (source_ == &::google::protobuf::internal::kEmptyString) {
    source_ = new ::std::string;
  }
...
inline void ImageGtDataParameter::set_source(const char* value, size_t size) {
  set_has_source();
  if (source_ == &::google::protobuf::internal::kEmptyString) {
    source_ = new ::std::string;
  }
...
inline ::std::string* ImageGtDataParameter::mutable_source() {
  set_has_source();
  if (source_ == &::google::protobuf::internal::kEmptyString) {
    source_ = new ::std::string;
  }
...
inline ::std::string* ImageGtDataParameter::release_source() {
  clear_has_source();
  if (source_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
inline void ImageGtDataParameter::set_allocated_source(::std::string* source) {
  if (source_ != &::google::protobuf::internal::kEmptyString) {
    delete source_;
  }
  if (source) {
...
// optional float scale = 2 [default = 1];
inline bool ImageGtDataParameter::has_scale() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ImageGtDataParameter::set_has_scale() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ImageGtDataParameter::clear_has_scale() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ImageGtDataParameter::clear_scale() {
  scale_ = 1;
  clear_has_scale();
}
inline float ImageGtDataParameter::scale() const {
  return scale_;
}
inline void ImageGtDataParameter::set_scale(float value) {
  set_has_scale();
  scale_ = value;
}

// optional string mean_file = 3;
inline bool ImageGtDataParameter::has_mean_file() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ImageGtDataParameter::set_has_mean_file() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ImageGtDataParameter::clear_has_mean_file() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ImageGtDataParameter::clear_mean_file() {
  if (mean_file_ != &::google::protobuf::internal::kEmptyString) {
    mean_file_->clear();
  }
  clear_has_mean_file();
}
inline const ::std::string& ImageGtDataParameter::mean_file() const {
  return *mean_file_;
}
inline void ImageGtDataParameter::set_mean_file(const ::std::string& value) {
  set_has_mean_file();
  if (mean_file_ == &::google::protobuf::internal::kEmptyString) {
    mean_file_ = new ::std::string;
  }
...
inline void ImageGtDataParameter::set_mean_file(const char* value) {
  set_has_mean_file();
  if (mean_file_ == &::google::protobuf::internal::kEmptyString) {
    mean_file_ = new ::std::string;
  }
...
inline void ImageGtDataParameter::set_mean_file(const char* value, size_t size) {
  set_has_mean_file();
  if (mean_file_ == &::google::protobuf::internal::kEmptyString) {
    mean_file_ = new ::std::string;
  }
...
inline ::std::string* ImageGtDataParameter::mutable_mean_file() {
  set_has_mean_file();
  if (mean_file_ == &::google::protobuf::internal::kEmptyString) {
    mean_file_ = new ::std::string;
  }
...
inline ::std::string* ImageGtDataParameter::release_mean_file() {
  clear_has_mean_file();
  if (mean_file_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
inline void ImageGtDataParameter::set_allocated_mean_file(::std::string* mean_file) {
  if (mean_file_ != &::google::protobuf::internal::kEmptyString) {
    delete mean_file_;
  }
  if (mean_file) {
...
// optional uint32 batch_size = 4;
inline bool ImageGtDataParameter::has_batch_size() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void ImageGtDataParameter::set_has_batch_size() {
  _has_bits_[0] |= 0x00000008u;
}
inline void ImageGtDataParameter::clear_has_batch_size() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void ImageGtDataParameter::clear_batch_size() {
  batch_size_ = 0u;
  clear_has_batch_size();
}
inline ::google::protobuf::uint32 ImageGtDataParameter::batch_size() const {
  return batch_size_;
}
inline void ImageGtDataParameter::set_batch_size(::google::protobuf::uint32 value) {
  set_has_batch_size();
  batch_size_ = value;
}

// optional bool mirror = 5 [default = false];
inline bool ImageGtDataParameter::has_mirror() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void ImageGtDataParameter::set_has_mirror() {
  _has_bits_[0] |= 0x00000010u;
}
inline void ImageGtDataParameter::clear_has_mirror() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void ImageGtDataParameter::clear_mirror() {
  mirror_ = false;
  clear_has_mirror();
}
inline bool ImageGtDataParameter::mirror() const {
  return mirror_;
}
inline void ImageGtDataParameter::set_mirror(bool value) {
  set_has_mirror();
  mirror_ = value;
}

// repeated uint32 downsample_rate = 6;
inline int ImageGtDataParameter::downsample_rate_size() const {
  return downsample_rate_.size();
}
inline void ImageGtDataParameter::clear_downsample_rate() {
  downsample_rate_.Clear();
}
inline ::google::protobuf::uint32 ImageGtDataParameter::downsample_rate(int index) const {
  return downsample_rate_.Get(index);
}
inline void ImageGtDataParameter::set_downsample_rate(int index, ::google::protobuf::uint32 value) {
  downsample_rate_.Set(index, value);
}
inline void ImageGtDataParameter::add_downsample_rate(::google::protobuf::uint32 value) {
  downsample_rate_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
ImageGtDataParameter::downsample_rate() const {
  return downsample_rate_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
ImageGtDataParameter::mutable_downsample_rate() {
  return &downsample_rate_;
}

// optional uint32 coord_num = 7 [default = 4];
inline bool ImageGtDataParameter::has_coord_num() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void ImageGtDataParameter::set_has_coord_num() {
  _has_bits_[0] |= 0x00000040u;
}
inline void ImageGtDataParameter::clear_has_coord_num() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void ImageGtDataParameter::clear_coord_num() {
  coord_num_ = 4u;
  clear_has_coord_num();
}
inline ::google::protobuf::uint32 ImageGtDataParameter::coord_num() const {
  return coord_num_;
}
inline void ImageGtDataParameter::set_coord_num(::google::protobuf::uint32 value) {
  set_has_coord_num();
  coord_num_ = value;
}

// repeated uint32 field_h = 8;
inline int ImageGtDataParameter::field_h_size() const {
  return field_h_.size();
}
inline void ImageGtDataParameter::clear_field_h() {
  field_h_.Clear();
}
inline ::google::protobuf::uint32 ImageGtDataParameter::field_h(int index) const {
  return field_h_.Get(index);
}
inline void ImageGtDataParameter::set_field_h(int index, ::google::protobuf::uint32 value) {
  field_h_.Set(index, value);
}
inline void ImageGtDataParameter::add_field_h(::google::protobuf::uint32 value) {
  field_h_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
ImageGtDataParameter::field_h() const {
  return field_h_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
ImageGtDataParameter::mutable_field_h() {
  return &field_h_;
}

// repeated uint32 field_w = 9;
inline int ImageGtDataParameter::field_w_size() const {
  return field_w_.size();
}
inline void ImageGtDataParameter::clear_field_w() {
  field_w_.Clear();
}
inline ::google::protobuf::uint32 ImageGtDataParameter::field_w(int index) const {
  return field_w_.Get(index);
}
inline void ImageGtDataParameter::set_field_w(int index, ::google::protobuf::uint32 value) {
  field_w_.Set(index, value);
}
inline void ImageGtDataParameter::add_field_w(::google::protobuf::uint32 value) {
  field_w_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
ImageGtDataParameter::field_w() const {
  return field_w_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
ImageGtDataParameter::mutable_field_w() {
  return &field_w_;
}

// optional float fg_threshold = 10 [default = 0.5];
inline bool ImageGtDataParameter::has_fg_threshold() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void ImageGtDataParameter::set_has_fg_threshold() {
  _has_bits_[0] |= 0x00000200u;
}
inline void ImageGtDataParameter::clear_has_fg_threshold() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void ImageGtDataParameter::clear_fg_threshold() {
  fg_threshold_ = 0.5f;
  clear_has_fg_threshold();
}
inline float ImageGtDataParameter::fg_threshold() const {
  return fg_threshold_;
}
inline void ImageGtDataParameter::set_fg_threshold(float value) {
  set_has_fg_threshold();
  fg_threshold_ = value;
}

// optional uint32 resize_width = 11;
inline bool ImageGtDataParameter::has_resize_width() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void ImageGtDataParameter::set_has_resize_width() {
  _has_bits_[0] |= 0x00000400u;
}
inline void ImageGtDataParameter::clear_has_resize_width() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void ImageGtDataParameter::clear_resize_width() {
  resize_width_ = 0u;
  clear_has_resize_width();
}
inline ::google::protobuf::uint32 ImageGtDataParameter::resize_width() const {
  return resize_width_;
}
inline void ImageGtDataParameter::set_resize_width(::google::protobuf::uint32 value) {
  set_has_resize_width();
  resize_width_ = value;
}

// optional uint32 resize_height = 12;
inline bool ImageGtDataParameter::has_resize_height() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void ImageGtDataParameter::set_has_resize_height() {
  _has_bits_[0] |= 0x00000800u;
}
inline void ImageGtDataParameter::clear_has_resize_height() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void ImageGtDataParameter::clear_resize_height() {
  resize_height_ = 0u;
  clear_has_resize_height();
}
inline ::google::protobuf::uint32 ImageGtDataParameter::resize_height() const {
  return resize_height_;
}
inline void ImageGtDataParameter::set_resize_height(::google::protobuf::uint32 value) {
  set_has_resize_height();
  resize_height_ = value;
}

// optional uint32 crop_width = 13 [default = 0];
inline bool ImageGtDataParameter::has_crop_width() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void ImageGtDataParameter::set_has_crop_width() {
  _has_bits_[0] |= 0x00001000u;
}
inline void ImageGtDataParameter::clear_has_crop_width() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void ImageGtDataParameter::clear_crop_width() {
  crop_width_ = 0u;
  clear_has_crop_width();
}
inline ::google::protobuf::uint32 ImageGtDataParameter::crop_width() const {
  return crop_width_;
}
inline void ImageGtDataParameter::set_crop_width(::google::protobuf::uint32 value) {
  set_has_crop_width();
  crop_width_ = value;
}

// optional uint32 crop_height = 14 [default = 0];
inline bool ImageGtDataParameter::has_crop_height() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void ImageGtDataParameter::set_has_crop_height() {
  _has_bits_[0] |= 0x00002000u;
}
inline void ImageGtDataParameter::clear_has_crop_height() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void ImageGtDataParameter::clear_crop_height() {
  crop_height_ = 0u;
  clear_has_crop_height();
}
inline ::google::protobuf::uint32 ImageGtDataParameter::crop_height() const {
  return crop_height_;
}
inline void ImageGtDataParameter::set_crop_height(::google::protobuf::uint32 value) {
  set_has_crop_height();
  crop_height_ = value;
}

// optional bool do_multiple_scale = 15 [default = false];
inline bool ImageGtDataParameter::has_do_multiple_scale() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void ImageGtDataParameter::set_has_do_multiple_scale() {
  _has_bits_[0] |= 0x00004000u;
}
inline void ImageGtDataParameter::clear_has_do_multiple_scale() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void ImageGtDataParameter::clear_do_multiple_scale() {
  do_multiple_scale_ = false;
  clear_has_do_multiple_scale();
}
inline bool ImageGtDataParameter::do_multiple_scale() const {
  return do_multiple_scale_;
}
inline void ImageGtDataParameter::set_do_multiple_scale(bool value) {
  set_has_do_multiple_scale();
  do_multiple_scale_ = value;
}

// optional uint32 min_scale = 16;
inline bool ImageGtDataParameter::has_min_scale() const {
  return (_has_bits_[0] & 0x00008000u) != 0;
}
inline void ImageGtDataParameter::set_has_min_scale() {
  _has_bits_[0] |= 0x00008000u;
}
inline void ImageGtDataParameter::clear_has_min_scale() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void ImageGtDataParameter::clear_min_scale() {
  min_scale_ = 0u;
  clear_has_min_scale();
}
inline ::google::protobuf::uint32 ImageGtDataParameter::min_scale() const {
  return min_scale_;
}
inline void ImageGtDataParameter::set_min_scale(::google::protobuf::uint32 value) {
  set_has_min_scale();
  min_scale_ = value;
}

// optional uint32 max_scale = 17;
inline bool ImageGtDataParameter::has_max_scale() const {
  return (_has_bits_[0] & 0x00010000u) != 0;
}
inline void ImageGtDataParameter::set_has_max_scale() {
  _has_bits_[0] |= 0x00010000u;
}
inline void ImageGtDataParameter::clear_has_max_scale() {
  _has_bits_[0] &= ~0x00010000u;
}
inline void ImageGtDataParameter::clear_max_scale() {
  max_scale_ = 0u;
  clear_has_max_scale();
}
inline ::google::protobuf::uint32 ImageGtDataParameter::max_scale() const {
  return max_scale_;
}
inline void ImageGtDataParameter::set_max_scale(::google::protobuf::uint32 value) {
  set_has_max_scale();
  max_scale_ = value;
}

// optional float min_whaspect = 18;
inline bool ImageGtDataParameter::has_min_whaspect() const {
  return (_has_bits_[0] & 0x00020000u) != 0;
}
inline void ImageGtDataParameter::set_has_min_whaspect() {
  _has_bits_[0] |= 0x00020000u;
}
inline void ImageGtDataParameter::clear_has_min_whaspect() {
  _has_bits_[0] &= ~0x00020000u;
}
inline void ImageGtDataParameter::clear_min_whaspect() {
  min_whaspect_ = 0;
  clear_has_min_whaspect();
}
inline float ImageGtDataParameter::min_whaspect() const {
  return min_whaspect_;
}
inline void ImageGtDataParameter::set_min_whaspect(float value) {
  set_has_min_whaspect();
  min_whaspect_ = value;
}

// optional float max_whaspect = 19;
inline bool ImageGtDataParameter::has_max_whaspect() const {
  return (_has_bits_[0] & 0x00040000u) != 0;
}
inline void ImageGtDataParameter::set_has_max_whaspect() {
  _has_bits_[0] |= 0x00040000u;
}
inline void ImageGtDataParameter::clear_has_max_whaspect() {
  _has_bits_[0] &= ~0x00040000u;
}
inline void ImageGtDataParameter::clear_max_whaspect() {
  max_whaspect_ = 0;
  clear_has_max_whaspect();
}
inline float ImageGtDataParameter::max_whaspect() const {
  return max_whaspect_;
}
inline void ImageGtDataParameter::set_max_whaspect(float value) {
  set_has_max_whaspect();
  max_whaspect_ = value;
}

// optional float min_gt_width = 20 [default = 0];
inline bool ImageGtDataParameter::has_min_gt_width() const {
  return (_has_bits_[0] & 0x00080000u) != 0;
}
inline void ImageGtDataParameter::set_has_min_gt_width() {
  _has_bits_[0] |= 0x00080000u;
}
inline void ImageGtDataParameter::clear_has_min_gt_width() {
  _has_bits_[0] &= ~0x00080000u;
}
inline void ImageGtDataParameter::clear_min_gt_width() {
  min_gt_width_ = 0;
  clear_has_min_gt_width();
}
inline float ImageGtDataParameter::min_gt_width() const {
  return min_gt_width_;
}
inline void ImageGtDataParameter::set_min_gt_width(float value) {
  set_has_min_gt_width();
  min_gt_width_ = value;
}

// optional float min_gt_height = 21 [default = 0];
inline bool ImageGtDataParameter::has_min_gt_height() const {
  return (_has_bits_[0] & 0x00100000u) != 0;
}
inline void ImageGtDataParameter::set_has_min_gt_height() {
  _has_bits_[0] |= 0x00100000u;
}
inline void ImageGtDataParameter::clear_has_min_gt_height() {
  _has_bits_[0] &= ~0x00100000u;
}
inline void ImageGtDataParameter::clear_min_gt_height() {
  min_gt_height_ = 0;
  clear_has_min_gt_height();
}
inline float ImageGtDataParameter::min_gt_height() const {
  return min_gt_height_;
}
inline void ImageGtDataParameter::set_min_gt_height(float value) {
  set_has_min_gt_height();
  min_gt_height_ = value;
}

// optional bool shuffle = 22 [default = false];
inline bool ImageGtDataParameter::has_shuffle() const {
  return (_has_bits_[0] & 0x00200000u) != 0;
}
inline void ImageGtDataParameter::set_has_shuffle() {
  _has_bits_[0] |= 0x00200000u;
}
inline void ImageGtDataParameter::clear_has_shuffle() {
  _has_bits_[0] &= ~0x00200000u;
}
inline void ImageGtDataParameter::clear_shuffle() {
  shuffle_ = false;
  clear_has_shuffle();
}
inline bool ImageGtDataParameter::shuffle() const {
  return shuffle_;
}
inline void ImageGtDataParameter::set_shuffle(bool value) {
  set_has_shuffle();
  shuffle_ = value;
}

// optional bool output_gt_boxes = 23 [default = false];
inline bool ImageGtDataParameter::has_output_gt_boxes() const {
  return (_has_bits_[0] & 0x00400000u) != 0;
}
inline void ImageGtDataParameter::set_has_output_gt_boxes() {
  _has_bits_[0] |= 0x00400000u;
}
inline void ImageGtDataParameter::clear_has_output_gt_boxes() {
  _has_bits_[0] &= ~0x00400000u;
}
inline void ImageGtDataParameter::clear_output_gt_boxes() {
  output_gt_boxes_ = false;
  clear_has_output_gt_boxes();
}
inline bool ImageGtDataParameter::output_gt_boxes() const {
  return output_gt_boxes_;
}
inline void ImageGtDataParameter::set_output_gt_boxes(bool value) {
  set_has_output_gt_boxes();
  output_gt_boxes_ = value;
}

// optional uint32 fg_img_multiple = 24 [default = 1];
inline bool ImageGtDataParameter::has_fg_img_multiple() const {
  return (_has_bits_[0] & 0x00800000u) != 0;
}
inline void ImageGtDataParameter::set_has_fg_img_multiple() {
  _has_bits_[0] |= 0x00800000u;
}
inline void ImageGtDataParameter::clear_has_fg_img_multiple() {
  _has_bits_[0] &= ~0x00800000u;
}
inline void ImageGtDataParameter::clear_fg_img_multiple() {
  fg_img_multiple_ = 1u;
  clear_has_fg_img_multiple();
}
inline ::google::protobuf::uint32 ImageGtDataParameter::fg_img_multiple() const {
  return fg_img_multiple_;
}
inline void ImageGtDataParameter::set_fg_img_multiple(::google::protobuf::uint32 value) {
  set_has_fg_img_multiple();
  fg_img_multiple_ = value;
}

// optional bool cache_images = 25 [default = false];
inline bool ImageGtDataParameter::has_cache_images() const {
  return (_has_bits_[0] & 0x01000000u) != 0;
}
inline void ImageGtDataParameter::set_has_cache_images() {
  _has_bits_[0] |= 0x01000000u;
}
inline void ImageGtDataParameter::clear_has_cache_images() {
  _has_bits_[0] &= ~0x01000000u;
}
inline void ImageGtDataParameter::clear_cache_images() {
  cache_images_ = false;
  clear_has_cache_images();
}
inline bool ImageGtDataParameter::cache_images() const {
  return cache_images_;
}
inline void ImageGtDataParameter::set_cache_images(bool value) {
  set_has_cache_images();
  cache_images_ = value;
}

// optional string root_folder = 26 [default = ""];
inline bool ImageGtDataParameter::has_root_folder() const {
  return (_has_bits_[0] & 0x02000000u) != 0;
}
inline void ImageGtDataParameter::set_has_root_folder() {
  _has_bits_[0] |= 0x02000000u;
}
inline void ImageGtDataParameter::clear_has_root_folder() {
  _has_bits_[0] &= ~0x02000000u;
}
inline void ImageGtDataParameter::clear_root_folder() {
  if (root_folder_ != &::google::protobuf::internal::kEmptyString) {
    root_folder_->clear();
  }
  clear_has_root_folder();
}
inline const ::std::string& ImageGtDataParameter::root_folder() const {
  return *root_folder_;
}
inline void ImageGtDataParameter::set_root_folder(const ::std::string& value) {
  set_has_root_folder();
  if (root_folder_ == &::google::protobuf::internal::kEmptyString) {
    root_folder_ = new ::std::string;
  }
...
inline void ImageGtDataParameter::set_root_folder(const char* value) {
  set_has_root_folder();
  if (root_folder_ == &::google::protobuf::internal::kEmptyString) {
    root_folder_ = new ::std::string;
  }
...
inline void ImageGtDataParameter::set_root_folder(const char* value, size_t size) {
  set_has_root_folder();
  if (root_folder_ == &::google::protobuf::internal::kEmptyString) {
    root_folder_ = new ::std::string;
  }
...
inline ::std::string* ImageGtDataParameter::mutable_root_folder() {
  set_has_root_folder();
  if (root_folder_ == &::google::protobuf::internal::kEmptyString) {
    root_folder_ = new ::std::string;
  }
...
inline ::std::string* ImageGtDataParameter::release_root_folder() {
  clear_has_root_folder();
  if (root_folder_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
inline void ImageGtDataParameter::set_allocated_root_folder(::std::string* root_folder) {
  if (root_folder_ != &::google::protobuf::internal::kEmptyString) {
    delete root_folder_;
  }
  if (root_folder) {
...
// optional uint32 cls_num = 1;
inline bool DetectionLossParameter::has_cls_num() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void DetectionLossParameter::set_has_cls_num() {
  _has_bits_[0] |= 0x00000001u;
}
inline void DetectionLossParameter::clear_has_cls_num() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void DetectionLossParameter::clear_cls_num() {
  cls_num_ = 0u;
  clear_has_cls_num();
}
inline ::google::protobuf::uint32 DetectionLossParameter::cls_num() const {
  return cls_num_;
}
inline void DetectionLossParameter::set_cls_num(::google::protobuf::uint32 value) {
  set_has_cls_num();
  cls_num_ = value;
}

// optional uint32 coord_num = 2 [default = 4];
inline bool DetectionLossParameter::has_coord_num() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void DetectionLossParameter::set_has_coord_num() {
  _has_bits_[0] |= 0x00000002u;
}
inline void DetectionLossParameter::clear_has_coord_num() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void DetectionLossParameter::clear_coord_num() {
  coord_num_ = 4u;
  clear_has_coord_num();
}
inline ::google::protobuf::uint32 DetectionLossParameter::coord_num() const {
  return coord_num_;
}
inline void DetectionLossParameter::set_coord_num(::google::protobuf::uint32 value) {
  set_has_coord_num();
  coord_num_ = value;
}

// optional float lambda = 3 [default = 1];
inline bool DetectionLossParameter::has_lambda() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void DetectionLossParameter::set_has_lambda() {
  _has_bits_[0] |= 0x00000004u;
}
inline void DetectionLossParameter::clear_has_lambda() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void DetectionLossParameter::clear_lambda() {
  lambda_ = 1;
  clear_has_lambda();
}
inline float DetectionLossParameter::lambda() const {
  return lambda_;
}
inline void DetectionLossParameter::set_lambda(float value) {
  set_has_lambda();
  lambda_ = value;
}

// optional uint32 field_h = 4;
inline bool DetectionLossParameter::has_field_h() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void DetectionLossParameter::set_has_field_h() {
  _has_bits_[0] |= 0x00000008u;
}
inline void DetectionLossParameter::clear_has_field_h() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void DetectionLossParameter::clear_field_h() {
  field_h_ = 0u;
  clear_has_field_h();
}
inline ::google::protobuf::uint32 DetectionLossParameter::field_h() const {
  return field_h_;
}
inline void DetectionLossParameter::set_field_h(::google::protobuf::uint32 value) {
  set_has_field_h();
  field_h_ = value;
}

// optional uint32 field_w = 5;
inline bool DetectionLossParameter::has_field_w() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void DetectionLossParameter::set_has_field_w() {
  _has_bits_[0] |= 0x00000010u;
}
inline void DetectionLossParameter::clear_has_field_w() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void DetectionLossParameter::clear_field_w() {
  field_w_ = 0u;
  clear_has_field_w();
}
inline ::google::protobuf::uint32 DetectionLossParameter::field_w() const {
  return field_w_;
}
inline void DetectionLossParameter::set_field_w(::google::protobuf::uint32 value) {
  set_has_field_w();
  field_w_ = value;
}

// optional uint32 downsample_rate = 6;
inline bool DetectionLossParameter::has_downsample_rate() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void DetectionLossParameter::set_has_downsample_rate() {
  _has_bits_[0] |= 0x00000020u;
}
inline void DetectionLossParameter::clear_has_downsample_rate() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void DetectionLossParameter::clear_downsample_rate() {
  downsample_rate_ = 0u;
  clear_has_downsample_rate();
}
inline ::google::protobuf::uint32 DetectionLossParameter::downsample_rate() const {
  return downsample_rate_;
}
inline void DetectionLossParameter::set_downsample_rate(::google::protobuf::uint32 value) {
  set_has_downsample_rate();
  downsample_rate_ = value;
}

// optional bool bb_smooth = 7 [default = true];
inline bool DetectionLossParameter::has_bb_smooth() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void DetectionLossParameter::set_has_bb_smooth() {
  _has_bits_[0] |= 0x00000040u;
}
inline void DetectionLossParameter::clear_has_bb_smooth() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void DetectionLossParameter::clear_bb_smooth() {
  bb_smooth_ = true;
  clear_has_bb_smooth();
}
inline bool DetectionLossParameter::bb_smooth() const {
  return bb_smooth_;
}
inline void DetectionLossParameter::set_bb_smooth(bool value) {
  set_has_bb_smooth();
  bb_smooth_ = value;
}

// optional float field_whr = 8 [default = 2];
inline bool DetectionLossParameter::has_field_whr() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void DetectionLossParameter::set_has_field_whr() {
  _has_bits_[0] |= 0x00000080u;
}
inline void DetectionLossParameter::clear_has_field_whr() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void DetectionLossParameter::clear_field_whr() {
  field_whr_ = 2;
  clear_has_field_whr();
}
inline float DetectionLossParameter::field_whr() const {
  return field_whr_;
}
inline void DetectionLossParameter::set_field_whr(float value) {
  set_has_field_whr();
  field_whr_ = value;
}

// optional float field_xyr = 9 [default = 2];
inline bool DetectionLossParameter::has_field_xyr() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void DetectionLossParameter::set_has_field_xyr() {
  _has_bits_[0] |= 0x00000100u;
}
inline void DetectionLossParameter::clear_has_field_xyr() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void DetectionLossParameter::clear_field_xyr() {
  field_xyr_ = 2;
  clear_has_field_xyr();
}
inline float DetectionLossParameter::field_xyr() const {
  return field_xyr_;
}
inline void DetectionLossParameter::set_field_xyr(float value) {
  set_has_field_xyr();
  field_xyr_ = value;
}

// optional float bg_threshold = 10 [default = 0.5];
inline bool DetectionLossParameter::has_bg_threshold() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void DetectionLossParameter::set_has_bg_threshold() {
  _has_bits_[0] |= 0x00000200u;
}
inline void DetectionLossParameter::clear_has_bg_threshold() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void DetectionLossParameter::clear_bg_threshold() {
  bg_threshold_ = 0.5f;
  clear_has_bg_threshold();
}
inline float DetectionLossParameter::bg_threshold() const {
  return bg_threshold_;
}
inline void DetectionLossParameter::set_bg_threshold(float value) {
  set_has_bg_threshold();
  bg_threshold_ = value;
}

// optional uint32 bg_multiple = 11 [default = 4];
inline bool DetectionLossParameter::has_bg_multiple() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void DetectionLossParameter::set_has_bg_multiple() {
  _has_bits_[0] |= 0x00000400u;
}
inline void DetectionLossParameter::clear_has_bg_multiple() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void DetectionLossParameter::clear_bg_multiple() {
  bg_multiple_ = 4u;
  clear_has_bg_multiple();
}
inline ::google::protobuf::uint32 DetectionLossParameter::bg_multiple() const {
  return bg_multiple_;
}
inline void DetectionLossParameter::set_bg_multiple(::google::protobuf::uint32 value) {
  set_has_bg_multiple();
  bg_multiple_ = value;
}

// optional string sample_mode = 12 [default = "random"];
inline bool DetectionLossParameter::has_sample_mode() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void DetectionLossParameter::set_has_sample_mode() {
  _has_bits_[0] |= 0x00000800u;
}
inline void DetectionLossParameter::clear_has_sample_mode() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void DetectionLossParameter::clear_sample_mode() {
  if (sample_mode_ != _default_sample_mode_) {
    sample_mode_->assign(*_default_sample_mode_);
  }
  clear_has_sample_mode();
}
inline const ::std::string& DetectionLossParameter::sample_mode() const {
  return *sample_mode_;
}
inline void DetectionLossParameter::set_sample_mode(const ::std::string& value) {
  set_has_sample_mode();
  if (sample_mode_ == _default_sample_mode_) {
    sample_mode_ = new ::std::string;
  }
  sample_mode_->assign(value);
}
inline void DetectionLossParameter::set_sample_mode(const char* value) {
  set_has_sample_mode();
  if (sample_mode_ == _default_sample_mode_) {
    sample_mode_ = new ::std::string;
  }
...
inline void DetectionLossParameter::set_sample_mode(const char* value, size_t size) {
  set_has_sample_mode();
  if (sample_mode_ == _default_sample_mode_) {
    sample_mode_ = new ::std::string;
  }
  sample_mode_->assign(reinterpret_cast<const char*>(value), size);
}
inline ::std::string* DetectionLossParameter::mutable_sample_mode() {
  set_has_sample_mode();
  if (sample_mode_ == _default_sample_mode_) {
    sample_mode_ = new ::std::string(*_default_sample_mode_);
  }
  return sample_mode_;
}
inline ::std::string* DetectionLossParameter::release_sample_mode() {
  clear_has_sample_mode();
  if (sample_mode_ == _default_sample_mode_) {
    return NULL;
  } else {
    ::std::string* temp = sample_mode_;
    sample_mode_ = const_cast< ::std::string*>(_default_sample_mode_);
    return temp;
  }
}
inline void DetectionLossParameter::set_allocated_sample_mode(::std::string* sample_mode) {
  if (sample_mode_ != _default_sample_mode_) {
    delete sample_mode_;
  }
  if (sample_mode) {
...
// optional bool objectness = 13 [default = false];
inline bool DetectionLossParameter::has_objectness() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void DetectionLossParameter::set_has_objectness() {
  _has_bits_[0] |= 0x00001000u;
}
inline void DetectionLossParameter::clear_has_objectness() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void DetectionLossParameter::clear_objectness() {
  objectness_ = false;
  clear_has_objectness();
}
inline bool DetectionLossParameter::objectness() const {
  return objectness_;
}
inline void DetectionLossParameter::set_objectness(bool value) {
  set_has_objectness();
  objectness_ = value;
}

// optional bool iou_weighted = 14 [default = false];
inline bool DetectionLossParameter::has_iou_weighted() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void DetectionLossParameter::set_has_iou_weighted() {
  _has_bits_[0] |= 0x00002000u;
}
inline void DetectionLossParameter::clear_has_iou_weighted() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void DetectionLossParameter::clear_iou_weighted() {
  iou_weighted_ = false;
  clear_has_iou_weighted();
}
inline bool DetectionLossParameter::iou_weighted() const {
  return iou_weighted_;
}
inline void DetectionLossParameter::set_iou_weighted(bool value) {
  set_has_iou_weighted();
  iou_weighted_ = value;
}

// optional bool pos_neg_weighted = 15 [default = false];
inline bool DetectionLossParameter::has_pos_neg_weighted() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void DetectionLossParameter::set_has_pos_neg_weighted() {
  _has_bits_[0] |= 0x00004000u;
}
inline void DetectionLossParameter::clear_has_pos_neg_weighted() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void DetectionLossParameter::clear_pos_neg_weighted() {
  pos_neg_weighted_ = false;
  clear_has_pos_neg_weighted();
}
inline bool DetectionLossParameter::pos_neg_weighted() const {
  return pos_neg_weighted_;
}
inline void DetectionLossParameter::set_pos_neg_weighted(bool value) {
  set_has_pos_neg_weighted();
  pos_neg_weighted_ = value;
}
...
// optional uint32 cls_num = 1;
inline bool DetectionAccuracyParameter::has_cls_num() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void DetectionAccuracyParameter::set_has_cls_num() {
  _has_bits_[0] |= 0x00000001u;
}
inline void DetectionAccuracyParameter::clear_has_cls_num() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void DetectionAccuracyParameter::clear_cls_num() {
  cls_num_ = 0u;
  clear_has_cls_num();
}
inline ::google::protobuf::uint32 DetectionAccuracyParameter::cls_num() const {
  return cls_num_;
}
inline void DetectionAccuracyParameter::set_cls_num(::google::protobuf::uint32 value) {
  set_has_cls_num();
  cls_num_ = value;
}

// optional uint32 coord_num = 2 [default = 4];
inline bool DetectionAccuracyParameter::has_coord_num() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void DetectionAccuracyParameter::set_has_coord_num() {
  _has_bits_[0] |= 0x00000002u;
}
inline void DetectionAccuracyParameter::clear_has_coord_num() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void DetectionAccuracyParameter::clear_coord_num() {
  coord_num_ = 4u;
  clear_has_coord_num();
}
inline ::google::protobuf::uint32 DetectionAccuracyParameter::coord_num() const {
  return coord_num_;
}
inline void DetectionAccuracyParameter::set_coord_num(::google::protobuf::uint32 value) {
  set_has_coord_num();
  coord_num_ = value;
}

// optional uint32 field_h = 3;
inline bool DetectionAccuracyParameter::has_field_h() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void DetectionAccuracyParameter::set_has_field_h() {
  _has_bits_[0] |= 0x00000004u;
}
inline void DetectionAccuracyParameter::clear_has_field_h() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void DetectionAccuracyParameter::clear_field_h() {
  field_h_ = 0u;
  clear_has_field_h();
}
inline ::google::protobuf::uint32 DetectionAccuracyParameter::field_h() const {
  return field_h_;
}
inline void DetectionAccuracyParameter::set_field_h(::google::protobuf::uint32 value) {
  set_has_field_h();
  field_h_ = value;
}

// optional uint32 field_w = 4;
inline bool DetectionAccuracyParameter::has_field_w() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void DetectionAccuracyParameter::set_has_field_w() {
  _has_bits_[0] |= 0x00000008u;
}
inline void DetectionAccuracyParameter::clear_has_field_w() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void DetectionAccuracyParameter::clear_field_w() {
  field_w_ = 0u;
  clear_has_field_w();
}
inline ::google::protobuf::uint32 DetectionAccuracyParameter::field_w() const {
  return field_w_;
}
inline void DetectionAccuracyParameter::set_field_w(::google::protobuf::uint32 value) {
  set_has_field_w();
  field_w_ = value;
}

// optional uint32 downsample_rate = 5;
inline bool DetectionAccuracyParameter::has_downsample_rate() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void DetectionAccuracyParameter::set_has_downsample_rate() {
  _has_bits_[0] |= 0x00000010u;
}
inline void DetectionAccuracyParameter::clear_has_downsample_rate() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void DetectionAccuracyParameter::clear_downsample_rate() {
  downsample_rate_ = 0u;
  clear_has_downsample_rate();
}
inline ::google::protobuf::uint32 DetectionAccuracyParameter::downsample_rate() const {
  return downsample_rate_;
}
inline void DetectionAccuracyParameter::set_downsample_rate(::google::protobuf::uint32 value) {
  set_has_downsample_rate();
  downsample_rate_ = value;
}

// optional uint32 top_k = 6 [default = 1];
inline bool DetectionAccuracyParameter::has_top_k() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void DetectionAccuracyParameter::set_has_top_k() {
  _has_bits_[0] |= 0x00000020u;
}
inline void DetectionAccuracyParameter::clear_has_top_k() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void DetectionAccuracyParameter::clear_top_k() {
  top_k_ = 1u;
  clear_has_top_k();
}
inline ::google::protobuf::uint32 DetectionAccuracyParameter::top_k() const {
  return top_k_;
}
inline void DetectionAccuracyParameter::set_top_k(::google::protobuf::uint32 value) {
  set_has_top_k();
  top_k_ = value;
}

// optional float field_whr = 7 [default = 2];
inline bool DetectionAccuracyParameter::has_field_whr() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void DetectionAccuracyParameter::set_has_field_whr() {
  _has_bits_[0] |= 0x00000040u;
}
inline void DetectionAccuracyParameter::clear_has_field_whr() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void DetectionAccuracyParameter::clear_field_whr() {
  field_whr_ = 2;
  clear_has_field_whr();
}
inline float DetectionAccuracyParameter::field_whr() const {
  return field_whr_;
}
inline void DetectionAccuracyParameter::set_field_whr(float value) {
  set_has_field_whr();
  field_whr_ = value;
}

// optional float field_xyr = 8 [default = 4];
inline bool DetectionAccuracyParameter::has_field_xyr() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void DetectionAccuracyParameter::set_has_field_xyr() {
  _has_bits_[0] |= 0x00000080u;
}
inline void DetectionAccuracyParameter::clear_has_field_xyr() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void DetectionAccuracyParameter::clear_field_xyr() {
  field_xyr_ = 4;
  clear_has_field_xyr();
}
inline float DetectionAccuracyParameter::field_xyr() const {
  return field_xyr_;
}
inline void DetectionAccuracyParameter::set_field_xyr(float value) {
  set_has_field_xyr();
  field_xyr_ = value;
}

// optional float bg_threshold = 9 [default = 0.5];
inline bool DetectionAccuracyParameter::has_bg_threshold() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void DetectionAccuracyParameter::set_has_bg_threshold() {
  _has_bits_[0] |= 0x00000100u;
}
inline void DetectionAccuracyParameter::clear_has_bg_threshold() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void DetectionAccuracyParameter::clear_bg_threshold() {
  bg_threshold_ = 0.5f;
  clear_has_bg_threshold();
}
inline float DetectionAccuracyParameter::bg_threshold() const {
  return bg_threshold_;
}
inline void DetectionAccuracyParameter::set_bg_threshold(float value) {
  set_has_bg_threshold();
  bg_threshold_ = value;
}

// optional bool objectness = 10 [default = false];
inline bool DetectionAccuracyParameter::has_objectness() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void DetectionAccuracyParameter::set_has_objectness() {
  _has_bits_[0] |= 0x00000200u;
}
inline void DetectionAccuracyParameter::clear_has_objectness() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void DetectionAccuracyParameter::clear_objectness() {
  objectness_ = false;
  clear_has_objectness();
}
inline bool DetectionAccuracyParameter::objectness() const {
  return objectness_;
}
inline void DetectionAccuracyParameter::set_objectness(bool value) {
  set_has_objectness();
  objectness_ = value;
}
...
// optional float fg_thr = 1 [default = 0];
inline bool BoxOutputParameter::has_fg_thr() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void BoxOutputParameter::set_has_fg_thr() {
  _has_bits_[0] |= 0x00000001u;
}
inline void BoxOutputParameter::clear_has_fg_thr() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void BoxOutputParameter::clear_fg_thr() {
  fg_thr_ = 0;
  clear_has_fg_thr();
}
inline float BoxOutputParameter::fg_thr() const {
  return fg_thr_;
}
inline void BoxOutputParameter::set_fg_thr(float value) {
  set_has_fg_thr();
  fg_thr_ = value;
}

// optional float iou_thr = 2 [default = 0.5];
inline bool BoxOutputParameter::has_iou_thr() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void BoxOutputParameter::set_has_iou_thr() {
  _has_bits_[0] |= 0x00000002u;
}
inline void BoxOutputParameter::clear_has_iou_thr() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void BoxOutputParameter::clear_iou_thr() {
  iou_thr_ = 0.5f;
  clear_has_iou_thr();
}
inline float BoxOutputParameter::iou_thr() const {
  return iou_thr_;
}
inline void BoxOutputParameter::set_iou_thr(float value) {
  set_has_iou_thr();
  iou_thr_ = value;
}

// optional string nms_type = 3 [default = "IOU"];
inline bool BoxOutputParameter::has_nms_type() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void BoxOutputParameter::set_has_nms_type() {
  _has_bits_[0] |= 0x00000004u;
}
inline void BoxOutputParameter::clear_has_nms_type() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void BoxOutputParameter::clear_nms_type() {
  if (nms_type_ != _default_nms_type_) {
    nms_type_->assign(*_default_nms_type_);
  }
  clear_has_nms_type();
}
inline const ::std::string& BoxOutputParameter::nms_type() const {
  return *nms_type_;
}
inline void BoxOutputParameter::set_nms_type(const ::std::string& value) {
  set_has_nms_type();
  if (nms_type_ == _default_nms_type_) {
    nms_type_ = new ::std::string;
  }
  nms_type_->assign(value);
}
inline void BoxOutputParameter::set_nms_type(const char* value) {
  set_has_nms_type();
  if (nms_type_ == _default_nms_type_) {
    nms_type_ = new ::std::string;
  }
...
inline void BoxOutputParameter::set_nms_type(const char* value, size_t size) {
  set_has_nms_type();
  if (nms_type_ == _default_nms_type_) {
    nms_type_ = new ::std::string;
  }
  nms_type_->assign(reinterpret_cast<const char*>(value), size);
}
inline ::std::string* BoxOutputParameter::mutable_nms_type() {
  set_has_nms_type();
  if (nms_type_ == _default_nms_type_) {
    nms_type_ = new ::std::string(*_default_nms_type_);
  }
  return nms_type_;
}
inline ::std::string* BoxOutputParameter::release_nms_type() {
  clear_has_nms_type();
  if (nms_type_ == _default_nms_type_) {
    return NULL;
  } else {
    ::std::string* temp = nms_type_;
    nms_type_ = const_cast< ::std::string*>(_default_nms_type_);
    return temp;
  }
}
inline void BoxOutputParameter::set_allocated_nms_type(::std::string* nms_type) {
  if (nms_type_ != _default_nms_type_) {
    delete nms_type_;
  }
  if (nms_type) {
...
// repeated uint32 field_h = 4;
inline int BoxOutputParameter::field_h_size() const {
  return field_h_.size();
}
inline void BoxOutputParameter::clear_field_h() {
  field_h_.Clear();
}
inline ::google::protobuf::uint32 BoxOutputParameter::field_h(int index) const {
  return field_h_.Get(index);
}
inline void BoxOutputParameter::set_field_h(int index, ::google::protobuf::uint32 value) {
  field_h_.Set(index, value);
}
inline void BoxOutputParameter::add_field_h(::google::protobuf::uint32 value) {
  field_h_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
BoxOutputParameter::field_h() const {
  return field_h_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
BoxOutputParameter::mutable_field_h() {
  return &field_h_;
}

// repeated uint32 field_w = 5;
inline int BoxOutputParameter::field_w_size() const {
  return field_w_.size();
}
inline void BoxOutputParameter::clear_field_w() {
  field_w_.Clear();
}
inline ::google::protobuf::uint32 BoxOutputParameter::field_w(int index) const {
  return field_w_.Get(index);
}
inline void BoxOutputParameter::set_field_w(int index, ::google::protobuf::uint32 value) {
  field_w_.Set(index, value);
}
inline void BoxOutputParameter::add_field_w(::google::protobuf::uint32 value) {
  field_w_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
BoxOutputParameter::field_w() const {
  return field_w_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
BoxOutputParameter::mutable_field_w() {
  return &field_w_;
}

// repeated uint32 downsample_rate = 6;
inline int BoxOutputParameter::downsample_rate_size() const {
  return downsample_rate_.size();
}
inline void BoxOutputParameter::clear_downsample_rate() {
  downsample_rate_.Clear();
}
inline ::google::protobuf::uint32 BoxOutputParameter::downsample_rate(int index) const {
  return downsample_rate_.Get(index);
}
inline void BoxOutputParameter::set_downsample_rate(int index, ::google::protobuf::uint32 value) {
  downsample_rate_.Set(index, value);
}
inline void BoxOutputParameter::add_downsample_rate(::google::protobuf::uint32 value) {
  downsample_rate_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
BoxOutputParameter::downsample_rate() const {
  return downsample_rate_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
BoxOutputParameter::mutable_downsample_rate() {
  return &downsample_rate_;
}

// optional float field_whr = 7 [default = 2];
inline bool BoxOutputParameter::has_field_whr() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void BoxOutputParameter::set_has_field_whr() {
  _has_bits_[0] |= 0x00000040u;
}
inline void BoxOutputParameter::clear_has_field_whr() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void BoxOutputParameter::clear_field_whr() {
  field_whr_ = 2;
  clear_has_field_whr();
}
inline float BoxOutputParameter::field_whr() const {
  return field_whr_;
}
inline void BoxOutputParameter::set_field_whr(float value) {
  set_has_field_whr();
  field_whr_ = value;
}

// optional float field_xyr = 8 [default = 2];
inline bool BoxOutputParameter::has_field_xyr() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void BoxOutputParameter::set_has_field_xyr() {
  _has_bits_[0] |= 0x00000080u;
}
inline void BoxOutputParameter::clear_has_field_xyr() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void BoxOutputParameter::clear_field_xyr() {
  field_xyr_ = 2;
  clear_has_field_xyr();
}
inline float BoxOutputParameter::field_xyr() const {
  return field_xyr_;
}
inline void BoxOutputParameter::set_field_xyr(float value) {
  set_has_field_xyr();
  field_xyr_ = value;
}

// optional uint32 max_nms_num = 9 [default = 0];
inline bool BoxOutputParameter::has_max_nms_num() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void BoxOutputParameter::set_has_max_nms_num() {
  _has_bits_[0] |= 0x00000100u;
}
inline void BoxOutputParameter::clear_has_max_nms_num() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void BoxOutputParameter::clear_max_nms_num() {
  max_nms_num_ = 0u;
  clear_has_max_nms_num();
}
inline ::google::protobuf::uint32 BoxOutputParameter::max_nms_num() const {
  return max_nms_num_;
}
inline void BoxOutputParameter::set_max_nms_num(::google::protobuf::uint32 value) {
  set_has_max_nms_num();
  max_nms_num_ = value;
}

// optional uint32 max_post_nms_num = 10 [default = 0];
inline bool BoxOutputParameter::has_max_post_nms_num() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void BoxOutputParameter::set_has_max_post_nms_num() {
  _has_bits_[0] |= 0x00000200u;
}
inline void BoxOutputParameter::clear_has_max_post_nms_num() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void BoxOutputParameter::clear_max_post_nms_num() {
  max_post_nms_num_ = 0u;
  clear_has_max_post_nms_num();
}
inline ::google::protobuf::uint32 BoxOutputParameter::max_post_nms_num() const {
  return max_post_nms_num_;
}
inline void BoxOutputParameter::set_max_post_nms_num(::google::protobuf::uint32 value) {
  set_has_max_post_nms_num();
  max_post_nms_num_ = value;
}

// optional float min_size = 11 [default = 15];
inline bool BoxOutputParameter::has_min_size() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void BoxOutputParameter::set_has_min_size() {
  _has_bits_[0] |= 0x00000400u;
}
inline void BoxOutputParameter::clear_has_min_size() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void BoxOutputParameter::clear_min_size() {
  min_size_ = 15;
  clear_has_min_size();
}
inline float BoxOutputParameter::min_size() const {
  return min_size_;
}
inline void BoxOutputParameter::set_min_size(float value) {
  set_has_min_size();
  min_size_ = value;
}
...
// optional uint32 cls_num = 1;
inline bool ProposalTargetParameter::has_cls_num() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void ProposalTargetParameter::set_has_cls_num() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ProposalTargetParameter::clear_has_cls_num() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ProposalTargetParameter::clear_cls_num() {
  cls_num_ = 0u;
  clear_has_cls_num();
}
inline ::google::protobuf::uint32 ProposalTargetParameter::cls_num() const {
  return cls_num_;
}
inline void ProposalTargetParameter::set_cls_num(::google::protobuf::uint32 value) {
  set_has_cls_num();
  cls_num_ = value;
}

// optional uint32 batch_size = 2 [default = 128];
inline bool ProposalTargetParameter::has_batch_size() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ProposalTargetParameter::set_has_batch_size() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ProposalTargetParameter::clear_has_batch_size() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ProposalTargetParameter::clear_batch_size() {
  batch_size_ = 128u;
  clear_has_batch_size();
}
inline ::google::protobuf::uint32 ProposalTargetParameter::batch_size() const {
  return batch_size_;
}
inline void ProposalTargetParameter::set_batch_size(::google::protobuf::uint32 value) {
  set_has_batch_size();
  batch_size_ = value;
}

// optional float fg_fraction = 3 [default = 0.25];
inline bool ProposalTargetParameter::has_fg_fraction() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ProposalTargetParameter::set_has_fg_fraction() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ProposalTargetParameter::clear_has_fg_fraction() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ProposalTargetParameter::clear_fg_fraction() {
  fg_fraction_ = 0.25f;
  clear_has_fg_fraction();
}
inline float ProposalTargetParameter::fg_fraction() const {
  return fg_fraction_;
}
inline void ProposalTargetParameter::set_fg_fraction(float value) {
  set_has_fg_fraction();
  fg_fraction_ = value;
}

// optional uint32 num_img_per_batch = 4 [default = 4];
inline bool ProposalTargetParameter::has_num_img_per_batch() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void ProposalTargetParameter::set_has_num_img_per_batch() {
  _has_bits_[0] |= 0x00000008u;
}
inline void ProposalTargetParameter::clear_has_num_img_per_batch() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void ProposalTargetParameter::clear_num_img_per_batch() {
  num_img_per_batch_ = 4u;
  clear_has_num_img_per_batch();
}
inline ::google::protobuf::uint32 ProposalTargetParameter::num_img_per_batch() const {
  return num_img_per_batch_;
}
inline void ProposalTargetParameter::set_num_img_per_batch(::google::protobuf::uint32 value) {
  set_has_num_img_per_batch();
  num_img_per_batch_ = value;
}

// optional float fg_thr = 5 [default = 0.5];
inline bool ProposalTargetParameter::has_fg_thr() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void ProposalTargetParameter::set_has_fg_thr() {
  _has_bits_[0] |= 0x00000010u;
}
inline void ProposalTargetParameter::clear_has_fg_thr() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void ProposalTargetParameter::clear_fg_thr() {
  fg_thr_ = 0.5f;
  clear_has_fg_thr();
}
inline float ProposalTargetParameter::fg_thr() const {
  return fg_thr_;
}
inline void ProposalTargetParameter::set_fg_thr(float value) {
  set_has_fg_thr();
  fg_thr_ = value;
}

// optional float bg_thr_hg = 6 [default = 0.5];
inline bool ProposalTargetParameter::has_bg_thr_hg() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void ProposalTargetParameter::set_has_bg_thr_hg() {
  _has_bits_[0] |= 0x00000020u;
}
inline void ProposalTargetParameter::clear_has_bg_thr_hg() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void ProposalTargetParameter::clear_bg_thr_hg() {
  bg_thr_hg_ = 0.5f;
  clear_has_bg_thr_hg();
}
inline float ProposalTargetParameter::bg_thr_hg() const {
  return bg_thr_hg_;
}
inline void ProposalTargetParameter::set_bg_thr_hg(float value) {
  set_has_bg_thr_hg();
  bg_thr_hg_ = value;
}

// optional float bg_thr_lw = 7 [default = 0.1];
inline bool ProposalTargetParameter::has_bg_thr_lw() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void ProposalTargetParameter::set_has_bg_thr_lw() {
  _has_bits_[0] |= 0x00000040u;
}
inline void ProposalTargetParameter::clear_has_bg_thr_lw() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void ProposalTargetParameter::clear_bg_thr_lw() {
  bg_thr_lw_ = 0.1f;
  clear_has_bg_thr_lw();
}
inline float ProposalTargetParameter::bg_thr_lw() const {
  return bg_thr_lw_;
}
inline void ProposalTargetParameter::set_bg_thr_lw(float value) {
  set_has_bg_thr_lw();
  bg_thr_lw_ = value;
}

// optional uint32 img_width = 8;
inline bool ProposalTargetParameter::has_img_width() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void ProposalTargetParameter::set_has_img_width() {
  _has_bits_[0] |= 0x00000080u;
}
inline void ProposalTargetParameter::clear_has_img_width() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void ProposalTargetParameter::clear_img_width() {
  img_width_ = 0u;
  clear_has_img_width();
}
inline ::google::protobuf::uint32 ProposalTargetParameter::img_width() const {
  return img_width_;
}
inline void ProposalTargetParameter::set_img_width(::google::protobuf::uint32 value) {
  set_has_img_width();
  img_width_ = value;
}

// optional uint32 img_height = 9;
inline bool ProposalTargetParameter::has_img_height() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void ProposalTargetParameter::set_has_img_height() {
  _has_bits_[0] |= 0x00000100u;
}
inline void ProposalTargetParameter::clear_has_img_height() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void ProposalTargetParameter::clear_img_height() {
  img_height_ = 0u;
  clear_has_img_height();
}
inline ::google::protobuf::uint32 ProposalTargetParameter::img_height() const {
  return img_height_;
}
inline void ProposalTargetParameter::set_img_height(::google::protobuf::uint32 value) {
  set_has_img_height();
  img_height_ = value;
}

// optional bool iou_weighted = 10 [default = false];
inline bool ProposalTargetParameter::has_iou_weighted() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void ProposalTargetParameter::set_has_iou_weighted() {
  _has_bits_[0] |= 0x00000200u;
}
inline void ProposalTargetParameter::clear_has_iou_weighted() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void ProposalTargetParameter::clear_iou_weighted() {
  iou_weighted_ = false;
  clear_has_iou_weighted();
}
inline bool ProposalTargetParameter::iou_weighted() const {
  return iou_weighted_;
}
inline void ProposalTargetParameter::set_iou_weighted(bool value) {
  set_has_iou_weighted();
  iou_weighted_ = value;
}
